...
The user wrote a function `is_valid_password` that failed specific unit tests.
Your goal is to fix the function based on the provided error messages.
...
Output ONLY the corrected Python code block containing the function. Do not output any explanation.
"""
